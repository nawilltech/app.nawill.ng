...
- **Email verification, project milestones/change-history/status-requests, blog/FAQ, file upload handling** — trimmed from this pass's MVP slice per [PRD §4.1](./PRD.md#41-mvp-phase-1) in favor of depth on money- and access-control-sensitive modules; untested because unbuilt, not because they were tested and cut.
